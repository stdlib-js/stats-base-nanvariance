...
```javascript
nanvariance = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanvariance@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-nanvariance/tags). For example,

```javascript
nanvariance = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanvariance@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var nanvariance = require( 'path/to/vendor/umd/stats-base-nanvariance/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanvariance@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-nanvariance.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-nanvariance

[test-image]: https://github.com/stdlib-js/stats-base-nanvariance/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-base-nanvariance/actions/workflows/test.yml?query=branch:v0.2.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-nanvariance/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-nanvariance?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-nanvariance.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-nanvariance/main
...
[deno-readme]: https://github.com/stdlib-js/stats-base-nanvariance/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-nanvariance/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-nanvariance/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-nanvariance/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-nanvariance/blob/esm/README.md
